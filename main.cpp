...
void interest_calc() {
  ...
  cout << "Enter;\n";
  cout << "Initial Amount = Rs. ";
  cin >> p;
  cout << "\n";
  cout << "Rate of interest(without %) = ";
  cin >> r;
  cout << "\n";
  cout << "No.of.years = ";
  cin >> n;
  cout << "\n";
  cout << "I need to calculate (1.Simple Interest/ 2.Compound Interest): ";
  cin >> inp;
  cout << "\n";
  if (inp == 1) {
    sinterest = p * n * r / 100;
...
class area: public mensuration {
  ...
  void cone() {
    cout << setw(11) << "Base Radius = ";
    cin >> r;
    cout << setw(10) << "Slant height = ";
    cin >> l;
    cout << "I want to calculate:\n";
    cout << setw(10) << "1. LSA\n";
    cout << setw(10) << "2. TSA\n";
  ...
  void frustum() {
    cout << setw(10) << "Base Radius-1 = ";
    cin >> r;
    cout << setw(10) << "Base Radius-2 = ";
    cin >> R;
    cout << setw(11) << "Slant height = ";
    cin >> l;
    cout << "I want to calculate:\n";
    cout << setw(10) << "1. LSA\n";
    cout << setw(10) << "2. TSA\n";
...
void unit_converter() {
  ...
  cin >> inp;
  if (inp == 1) {
    cout << "I need to find {mph/kph}: ";
    cin >> inp2;
    string stemp1 = "mph", stemp2 = "kph";
    if (inp2 == stemp2) {
      cout << setw(10) << "mph = " << setw(10);
      cin >> inp3;
      kph = inp3 * 1.60934;
      cout << setw(10) << "kph = " << kph << endl;
    } else if (inp2 == stemp1) {
      cout << setw(10) << "kph = " << setw(10);
      cin >> inp4;
      mph = inp4 / 1.60934;
    ...
    cout << "I need to find (celsius/fahrenheit): ";
    cin >> ainp;
